...
dataName(22)={'KappaExp-1-2.csv'};
dataName(23)={'KappaExp-2-2.csv'};
dataName(24)={'KappaExp-3-2.csv'};
dataName(25)={'KappaExp-4-2.csv'};
dataName(26)={'KappaExp-5-2.csv'};
dataName(27)={'KappaExp-6-2.csv'};
dataName(28)={'KappaExp-7-2.csv'};
dataName(29)={'KappaExp-8-2.csv'};
dataName(30)={'KappaExp-9-2.csv'};
dataName(31)={'KappaExp-10-2.csv'};
dataName(32)={'KappaExp-11-2.csv'};
dataName(33)={'KappaExp-12-2.csv'};
dataName(34)={'KappaExp-13-2.csv'};
dataName(35)={'KappaExp-14-2.csv'};
dataName(36)={'KappaExp-15-2.csv'};
dataName(37)={'KappaExp-16-2.csv'};
dataName(38)={'KappaExp-17-2.csv'};
dataName(39)={'KappaExp-18-2.csv'};
dataName(40)={'KappaExp-19-2.csv'};
dataName(41)={'KappaExp-20-2.csv'};
dataName(42)={'KappaExp-21-2.csv'};
...
savepath='./';
save(strcat(savepath,'bootlogCon.mat'),'bootlog');
clear bootlog;
...
function [c,ceq] = maxSDpri(x)

c = sqrt(x(1)/(1-x(1)))*x(2)-3.604;
ceq = [];
...
nonlcon = @maxSDpri;
[a1, fval] = fmincon(@(a1) LogFun(a1,k), c1, A, b, Aeq, beq, lb, ub,nonlcon); 
